...
Reusable, generalizable recipes — one per domain/concern/scope (business or tech). They make this
repo a **starter** for future projects (project vocation #2) and feed future articles.
